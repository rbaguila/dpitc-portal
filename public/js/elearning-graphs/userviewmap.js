...
$(function () {
    var data = {
        ...
        'Ocean Environment Services (OES)': {
            'Bathymetry': {
                'Views': '59.0'
            },
            'Corals': {
        ...
        'Inland Environment Services (IES)': {
            'Biodiversity': {
                'Views': '59.0'
            },
            'Climate Change': {
    ...
    Highcharts.chart('userViewByISP', {
        ...
        subtitle: {
            text: 'Number of Views by ISP and Sector'
        },
        title: {
...
$(function () {
    ...
    series: [{
        type: 'column',
        name: 'Like',
        data: [3, 2, 1, 3, 4, 3, 2, 1, 3, 4, 12, 6]
    }, {
        type: 'column',
        name: 'Happy',
        data: [2, 3, 5, 7, 6, 2, 3, 5, 7, 6, 6, 10]
    }, {
        type: 'column',
        name: 'Sad',
        data: [4, 3, 3, 9, 0, 4, 3, 3, 9, 1, 11]
    }, {
        type: 'spline',
        name: 'Average',
        data: [3, 2.67, 3, 6.33, 3.33, 3, 2.67, 3, 6.33, 3.67, 9.67, 5.33],
        marker: {
            lineWidth: 2,
